...
// res = (html && css && bootstrap && !js && !react && !node)
//         ? console.log("You can become a UI/UX Designer")
//         : (html && css && bootstrap && js && react && !node)
//             ? console.log("You can become a Frontend Developer")
//             : (html && css && bootstrap && js && !react && node)
//                 ? console.log("You can become a Backend Developer")
//                     : (html && css && bootstrap && js && react && node)
//                         ? console.log("You can become a FullStack Developer")
//                         : console.log("Don't worry. If you want to learn these skills, then Go and Join 10000 Coders.")
